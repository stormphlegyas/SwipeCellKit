...
open class SwipeTableNodeCell: ASCellNode {
    ...
    weak var scrollView: UIScrollView? {
        _scrollView = tableView ?? collectionView
        swipeController.scrollView = _scrollView
        return _scrollView
    }
    ...
    var swipeController: SwipeNodeController!
    var isPreviouslySelected = false
    
    weak var tableView: UITableView?{
        return view.superview?.superview?.superview as? UITableView
    }
    weak var collectionView: UICollectionView?{
        return view.superview?.superview?.superview as? UICollectionView
    }
    ...
    func configure() {
        ...
        swipeController = SwipeNodeController(swipeable: self)
